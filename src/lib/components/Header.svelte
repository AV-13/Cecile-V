			...
			<div class="dropdown-menu-background">
				...
				<div class="burger-menu-doctolib-button">
					<a
						...
						style="display:flex;text-align:center;background-color:#107ACA;color:#ffffff;font-size:14px;overflow:hidden;font-family:Roboto, sans-serif;box-sizing:border-box;align-items:center;padding:0 24px;z-index:1000;height:48px;text-decoration:none;border-radius:24px;width:fit-content;margin:0 auto"
						target="_blank"
						rel="noopener">
						Prendre rendez-vous
						<img
